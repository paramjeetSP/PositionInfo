...
{
    public partial class Recovered_hrmsnew_coreContext : DbContext
    {
        public Recovered_hrmsnew_coreContext()
        {
        }

        public Recovered_hrmsnew_coreContext(DbContextOptions<Recovered_hrmsnew_coreContext> options)
            : base(options)
        {
        }
...
//                optionsBuilder.UseSqlServer("Server=192.168.0.12\\SQLEXPRESS;Database=Recovered_hrmsnew_core;User Id=Softprod;Password=Softprodigy$*!;");
//            }
//        }
