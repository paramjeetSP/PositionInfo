...
namespace PositionInfo.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public async Task<IActionResult> GetEmpLeave(int EmpId, int fkLeaveType)
        {
            ...
            SaveNewLeaveData = (from emp in _context.Employees
                                join dept in _context.TblEDepartments on emp.FkDepartment equals dept.Id
                                join emp1 in _context.Employees on emp.ReportingTo equals emp1.Id
                                join emp2 in _context.Employees on emp.ProjectReportingTo equals emp2.Id
                                where emp.Id == EmpId
                                orderby emp.Id
